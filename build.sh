...
(clang  src/monkey_test/test.o src/monkey_test/test_ast.o src/monkey_test/test_lexer.o src/monkey_test/test_parser.o -o monkey_test.exe libmonkey.a libsds.a libvec.a libhash.a)
