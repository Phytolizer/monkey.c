...
cd "src/vec/src"
(clang -Wall -Wextra -Wpedantic -Werror=implicit-function-declaration -Werror=return-type -Werror=incompatible-pointer-types -std=c99 -g3 -I../../../inc -c vec.c -o vec.o)
cd "../../monkey_repl"
(clang -Wall -Wextra -Wpedantic -Werror=implicit-function-declaration -Werror=return-type -Werror=incompatible-pointer-types -std=c99 -g3 -I../../inc -c main.c -o main.o)
...
cd "../libnonstd"
(clang -Wall -Wextra -Wpedantic -Werror=implicit-function-declaration -Werror=return-type -Werror=incompatible-pointer-types -std=c99 -g3 -I../../inc -c strdup.c -o strdup.o)
(clang -Wall -Wextra -Wpedantic -Werror=implicit-function-declaration -Werror=return-type -Werror=incompatible-pointer-types -std=c99 -g3 -I../../inc -c strpbrk.c -o strpbrk.o)
(clang -Wall -Wextra -Wpedantic -Werror=implicit-function-declaration -Werror=return-type -Werror=incompatible-pointer-types -std=c99 -g3 -I../../inc -c strspn.c -o strspn.o)
(clang -Wall -Wextra -Wpedantic -Werror=implicit-function-declaration -Werror=return-type -Werror=incompatible-pointer-types -std=c99 -g3 -I../../inc -c strtok.c -o strtok.o)
cd "../monkey_test"
...
cd "../libhash"
(clang -Wall -Wextra -Wpedantic -Werror=implicit-function-declaration -Werror=return-type -Werror=incompatible-pointer-types -std=c99 -g3 -I../../inc -c fnv.c -o fnv.o)
(clang -Wall -Wextra -Wpedantic -Werror=implicit-function-declaration -Werror=return-type -Werror=incompatible-pointer-types -std=c99 -g3 -I../../inc -c hash.c -o hash.o)
cd "../sds"
